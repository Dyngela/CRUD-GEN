...
CREATE TABLE IF NOT EXISTS `Template` (
    ...
    CONSTRAINT `Fk_CompanyId_Template`
...
CREATE TABLE IF NOT EXISTS `Family_Template` (
    ...
    CONSTRAINT `Fk_FamilyTemplate_Id`
    FOREIGN KEY (`FamilyTemplate_Id`)
    REFERENCES `OrderableContent` (`OrderableContent_Id`),
    CONSTRAINT `Fk_ThumbnailFileRefId_Family_Template`
    FOREIGN KEY (`ThumbnailFileRefId`)
    REFERENCES `FileRef` (`FileRef_Id`),
    CONSTRAINT `Fk_TextFileRefId_Family_Template`
    FOREIGN KEY (`TextFileRefId`)
    REFERENCES `FileRef` (`FileRef_Id`))
    ENGINE = InnoDB
    AUTO_INCREMENT = 1
    DEFAULT CHARACTER SET = utf16
...
CREATE TABLE IF NOT EXISTS `Product` (
    ...
    CONSTRAINT `FK_Compagny_Id`
    FOREIGN KEY (`Company_Id`)
    REFERENCES `Company` (`Company_Id`),
    CONSTRAINT `FK_ProductRange_Id`
    FOREIGN KEY (`ProductRange_Id`)
    REFERENCES `ProductRange` (`ProductRange_Id`),
    CONSTRAINT `FK_ProductType_Id`
...
CREATE TABLE IF NOT EXISTS `ProductTemplate` (
    ...
    CONSTRAINT `Fk_ThumbnailFileRefId_Product_Template`
    FOREIGN KEY (`ThumbnailFileRefId`)
    REFERENCES `FileRef` (`FileRef_Id`),
    CONSTRAINT `Fk_TextFileRefId_Product_Template`
    FOREIGN KEY (`TextFileRefId`)
    REFERENCES `FileRef` (`FileRef_Id`))
    ENGINE = InnoDB
    AUTO_INCREMENT = 1
